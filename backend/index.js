...
app.get("/chooseside", (req, res) =>
  res.sendFile("html/chooseside.html", {
    root: __dirname,
  })
);
...
app.get("/tutorlogin", (req, res) =>
  res.sendFile("html/tutorlogin.html", {
    root: __dirname,
  })
);
app.get("/studentlogin", (req, res) =>
  res.sendFile("html/studentlogin.html", {
    root: __dirname,
  })
);
...
app.get("/tutorregister", (req, res) =>
  res.sendFile("html/tutorregister.html", {
    root: __dirname,
  })
);
app.get("/studentregister", (req, res) =>
  res.sendFile("html/studentregister.html", {
    root: __dirname,
  })
);

app.get("/tutorprofile", (req, res) =>
  res.sendFile("html/tutorprofile.html", {
    root: __dirname,
  })
);
app.get("/studentprofile", (req, res) =>
  res.sendFile("html/studentprofile.html", {
    root: __dirname,
  })
);
...
app.get("/oldhome", (req, res) =>
  res.sendFile("html/home_old.html", {
    root: __dirname,
  })
);
app.get("/emailconfirm", (req, res) =>
  res.sendFile("html/emailconfirm.html", {
    root: __dirname,
  })
);
app.get("/tutorpersonalinfo", (req, res) =>
  res.sendFile("html/tutorpersonalinfo.html", {
    root: __dirname,
  })
);

app.get("/videoupload", (req, res) =>
  res.sendFile("html/videoupload.html", {
    root: __dirname,
  })
);

app.get("/videoupdate", (req, res) =>
  res.sendFile("html/videoupdate.html", {
    root: __dirname,
  })
);

app.get("/videoshow", (req, res) =>
  res.sendFile("html/videoshow.html", {
    root: __dirname,
  })
);

app.get("/videohome", (req, res) =>
  res.sendFile("html/videohome.html", {
    root: __dirname,
  })
);

app.get("/video", (req, res) =>
  res.sendFile("html/singlevideo.html", {
    root: __dirname,
  })
);

app.get("/payment", (req, res) =>
  res.sendFile("html/payment.html", {
    root: __dirname,
  })
);

app.get("/testbank", (req, res) =>
  res.sendFile("html/testbank.html", {
    root: __dirname,
  })
);

app.get("/addtestbank", (req, res) =>
  res.sendFile("html/questioninput.html", {
    root: __dirname,
  })
);

app.get("/course", (req, res) =>
  res.sendFile("html/course.html", {
    root: __dirname,
  })
);
...
app.post("/addquestionbank/:vid", (req, res) => {
  awsapi.readvideoitem(
    "questionbank",
    req.params.vid,
    undefined,
    ...
    function (x) {
      ...
      if (Object.keys(x).length === 0 && x.constructor === Object) {
        ...
        tempquestionobj.body.push(req.body);
      }
      console.log(tempquestionobj);
      awsapi.createitem("questionbank", tempquestionobj, req, res);
    }
  );
});

app.get("/getquestionbank/:vid", (req, res) => {
  awsapi.readvideoitem(
    "questionbank",
    req.params.vid,
    undefined,
...
app.post("/updatepurchaselist/:uid", (req, res) => {
  var tempobj = {
    body: [req.body],
    uid: req.params.uid,
  };
  ...
  console.log(tempobj);
  awsapi.createitem("userpurchase", tempobj, req, res);
});
