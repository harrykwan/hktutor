...
app.get('/tutorlogin', (req, res) => res.sendFile('html/tutorlogin.html', { root: __dirname }))
app.get('/studentlogin', (req, res) => res.sendFile('html/studentlogin.html', { root: __dirname }))
